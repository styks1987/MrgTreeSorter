...
echo
	...
	$this->Html->div('menu_settings',
		...
		$this->Autocomplete->input('menu_item_parent_id', (!empty($menu_item))?$menu_item['MenuItem']['parent_id']:false, (!empty($menu_item))?$menu_item['ParentMenuItem']['link_text']:false, '/admin/menu_items/autocomplete', 'link_text', ['label'=>'Parent Menu Item<br /><small>Type the title of the parent menu item and choose it from the list.</small>']).
